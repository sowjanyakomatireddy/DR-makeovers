        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="flex flex-col justify-center items-start p-10 md:p-20 bg-dark-900">
                ...
                <p className="text-gray-300 leading-relaxed text-lg mb-8 font-light">
                    Welcome to DR Makeovers, your premier destination for personalized luxury and transformative beauty. We are more than just a salon; we are an exclusive retreat dedicated to crafting and perfecting your signature style.
                </p>
      ...
      <section className="py-20 bg-dark-800">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 px-4 max-w-7xl mx-auto h-[600px]">
            <div className="col-span-1 md:col-span-2 row-span-2 relative overflow-hidden group">
                <img src="https://images.unsplash.com/photo-1521590832896-013c4c8d2ac8?q=80&w=1976&auto=format&fit=crop" alt="Gallery 1" className="w-full h-full object-cover transition duration-700 group-hover:scale-110" />
            ...
            <div className="relative overflow-hidden group">
                <img src="https://images.unsplash.com/photo-1595476103518-3c8bed0a14e1?q=80&w=2070&auto=format&fit=crop" alt="Gallery 2" className="w-full h-full object-cover transition duration-700 group-hover:scale-110" />
            </div>
            <div className="relative overflow-hidden group">
                <img src="https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?q=80&w=2069&auto=format&fit=crop" alt="Gallery 3" className="w-full h-full object-cover transition duration-700 group-hover:scale-110" />
            </div>
            <div className="relative overflow-hidden group md:col-span-2">
                <img src="https://images.unsplash.com/photo-1633681926022-84c23e8cb2d6?q=80&w=2070&auto=format&fit=crop" alt="Gallery 4" className="w-full h-full object-cover transition duration-700 group-hover:scale-110" />
            </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
            <details className="group">
                <summary className="flex justify-between items-center font-medium cursor-pointer list-none text-gold-500">
                    <span className="text-sm uppercase tracking-widest">DR Makeovers – Luxury Unisex Salon in Hyderabad</span>
                ...
                <div className="text-gray-400 mt-4 group-open:animate-fadeIn text-sm leading-relaxed space-y-4">
                    ...
                    <p>DR Makeovers stands as one of the most premium unisex salons in Hyderabad, delivering world-class grooming, haircare, skincare, nail art, and bridal makeover solutions with exceptional finesse. Designed to offer a sophisticated blend of artistry and innovation, our salon provides an immersive luxury experience where comfort meets craftsmanship.</p>
                    <p>From advanced hair transformations to rejuvenating skin rituals, detailed nail enhancements to elegant bridal looks, DR Makeovers sets a new benchmark.</p>
                </div>
            </details>
        </div>
      </section>
      ...
      <section className="bg-dark-800 py-20">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-12 px-4">
              ...
              <div className="relative h-[500px] lg:h-auto mt-8 lg:mt-0">
                  <img 
                    src="https://images.unsplash.com/photo-1630230282276-857e497d3077?q=80&w=1974&auto=format&fit=crop" 
